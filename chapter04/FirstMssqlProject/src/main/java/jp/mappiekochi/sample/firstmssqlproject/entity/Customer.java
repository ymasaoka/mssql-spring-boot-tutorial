...
@Entity
@NamedQueries({
        @NamedQuery(name = "findByCustomerId", query = "from Customer where customerId = :cId"),
        @NamedQuery(name = "findByName", query = "from Customer where firstName like :fName or lastName like :lName"),
        @NamedQuery(name = "findByCustomerIdOrName", query = "from Customer where customerId = :cId or firstName like :fName or lastName like :lName")
})
